...
public class RabbitEmployee {
    ...
    public static final String EMPLOYEE_INSERT_EVENT = "employee-insert-event";
    ...
    public static final String TO_SERVICE_EMPLOYEE_EVENT_QUEUE = "to-service-employee-event-queue";
